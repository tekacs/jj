...
fn test_evolog_with_or_without_diff() {
    ...
    │  my description
    │  -- operation 4f6bc7783a13 snapshot working copy
    ×  rlvkpnrz hidden test.user@example.com 2001-02-03 08:05:09 c590b46c conflict
    │  my description
    │  -- operation e13cc78e8f93 rebase commit 51e08f95160c897080d035d330aead3ee6ed5588
    ...
    │  [1mmy description[0m
    │  [38;5;8m--[39m operation [38;5;4m4f6bc7783a13[39m snapshot working copy
    [1m[38;5;1m×[0m  [1m[39mr[0m[38;5;8mlvkpnrz[39m hidden [38;5;3mtest.user@example.com[39m [38;5;6m2001-02-03 08:05:09[39m [1m[38;5;4mc5[0m[38;5;8m90b46c[39m [38;5;1mconflict[39m
    │  my description
    │  [38;5;8m--[39m operation [38;5;4me13cc78e8f93[39m rebase commit 51e08f95160c897080d035d330aead3ee6ed5588
    ...
    │     1     : <<<<<<< Conflict 1 of 1
    │     2     : %%%%%%% Changes in rebase destination (zzzzzzzz 00000000) compared to qpvuntsm c664a51b
    │     3     : -foo
    │     4     : +++++++ Contents of rebased commit (rlvkpnrz 51e08f95)
    │     5     : foo
    │     6     : bar
    ...
    @@ -1,7 +1,1 @@
    -<<<<<<< Conflict 1 of 1
    -%%%%%%% Changes in rebase destination (zzzzzzzz 00000000) compared to qpvuntsm c664a51b
    --foo
    -+++++++ Contents of rebased commit (rlvkpnrz 51e08f95)
    -foo
    -bar
...
fn test_evolog_with_custom_symbols() {
    ...
    $  rlvkpnrz test.user@example.com 2001-02-03 08:05:10 33c10ace
    │  my description
    │  -- operation 0001903ec159 snapshot working copy
    ┝  rlvkpnrz hidden test.user@example.com 2001-02-03 08:05:09 c590b46c conflict
    │  my description
    │  -- operation e13cc78e8f93 rebase commit 51e08f95160c897080d035d330aead3ee6ed5588
    ┝  rlvkpnrz hidden test.user@example.com 2001-02-03 08:05:09 51e08f95
