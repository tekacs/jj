...
fn test_new_merge_conflicts() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv 78699dbc (conflict) (empty) (no description set)
    ...
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes in royxmykx 1b282e07 compared to rlvkpnrz a93ed0a5
    -1a
    +3a 1a
    +++++++ Contents of zsuskuln 7ac709e5
    1a 2a
...
fn test_new_merge_same_change() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: znkkpsqq 7f8ea854 (conflict) (empty) (no description set)
    Parent commit (@-)      : royxmykx 1b9fe696 3 | 3
    Parent commit (@-)      : zsuskuln 829e1e90 2 | 2
    Added 1 files, modified 0 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    ...
    a
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes in royxmykx 1b9fe696 compared to rlvkpnrz 2adf972b
    +b
    +++++++ Contents of zsuskuln 829e1e90
    b
    >>>>>>> Conflict 1 of 1 ends
    ");
}
