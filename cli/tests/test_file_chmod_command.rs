...
fn test_chmod_regular_conflict() {
    ...
    insta::assert_snapshot!(output, @r"
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes in royxmykx 02247291 compared to rlvkpnrz 1792382a
    -base
    +x
    +++++++ Contents of zsuskuln eb0ba805
    n
    ...
    Working copy  (@) now at: yostqsxw a573cc0f conflict | (conflict) conflict
...
fn test_chmod_file_dir_deletion_conflicts() {
    ...
    insta::assert_snapshot!(output, @r"
    <<<<<<< Conflict 1 of 1
    +++++++ Contents of zsuskuln bc9cdea1
    a
    %%%%%%% Changes in royxmykx d7d39332 compared to rlvkpnrz 1792382a
    -base
    >>>>>>> Conflict 1 of 1 ends
    [EOF]
    ");
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: kmkuslsw 3e483d61 file_deletion | (conflict) file_deletion
    ...
    New conflicts appeared in 1 commits:
      kmkuslsw 3e483d61 file_deletion | (conflict) file_deletion
